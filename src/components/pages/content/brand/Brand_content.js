...
import Brand_member from './Brand_member';
...
function Brand_contetnt() {
	...
	return (
		<section className='content brand'>
			<div className='inner'>
				<figure className='logo' tabIndex={0}>
					<h1>CHROME KICHEN - TECHNOLOGY WITH STYLE</h1>
					<div className='svg'>
						<svg xmlns='http://www.w3.org/2000/svg' viewBox='-10 -10 600 540'>
							<path
								ref={scr}
				...
				<div className='story' tabIndex={0}>
					<div
						className='pics'
						ref={ref}
						onTouchStart={(e) => {
						...
						<div className='brand-article' role='article' tabIndex={0}>
